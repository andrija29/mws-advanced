 ...
 * If you pass parameters to the constructor, they will be passed to @see {@link MwsAdvanced#init}
 * @class MwsAdvanced
...
class MwsAdvanced {
    constructor(...args) {
        ...
        this.listOrdersByNextToken = this.listOrdersByNextToken.bind(this);
     ...
     * @param {string[]} options.MarketplaceId Array of Marketplace IDs to search @see {@link constants}
     ...
     * @returns {Array.<detailedOrderInfo>} Array of detailedOrderInfo for given search parameters
     */
    listOrders(...params) {
    ...
    /**
     * Returns orders page based on NextToken.
     * 
     * If you've pulled a list of orders using @see {@link ListOrders} you will get NextToken in return.
     * see https://docs.developer.amazonservices.com/en_UK/orders-2013-09-01/Orders_ListOrdersByNextToken.html
     * NextToken must be specified. Error messages may or may not return information 
     * on what parameters you are missing.
     * If you are having trouble, see the official parameter documentation above.
     *
     * @param {object} options
     * @param {string} [options.NextToken] NextToken, see MWS doc page
     * @returns {Array.<detailedOrderInfo>} Array of detailedOrderInfo for given search parameters
     */
    listOrdersByNextToken(...params) {
        const helper = require('./helpers/listOrdersByNextToken');
        return helper(this)(...params);
    }

    static listOrdersByNextToken(...params) { return staticMws.listOrdersByNextToken(...params); }
     ...
     *
     * @param {object} options
     * @param {string[]} options.AmazonOrderId A list of AmazonOrderId values. An AmazonOrderId is an Amazon-defined order identifier, in 3-7-7 format.
     * @returns {detailedOrderInfo|Array.<detailedOrderInfo>} If only one order is returned, the detailed order info is returned bare, otherwise an array of detailedOrderInfos is returned
     */
    getOrder(...params) {
